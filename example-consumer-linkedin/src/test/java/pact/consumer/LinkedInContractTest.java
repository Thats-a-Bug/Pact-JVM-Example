...
public class LinkedInContractTest
{
    ...
    public RequestResponsePact linkedinInfoPact(final PactDslWithProvider builder)
    {
        return builder
            ...
            .body(getLinkedInInfoResponse())
            .toPact();
    }

    @NotNull
    private DslPart getLinkedInInfoResponse()
    {
    ...
    @Test
    @PactVerification(fragment = "linkedinInfoPact" )
    public void checkLinkedInData()
    {
